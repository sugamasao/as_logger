...
=== result(not use -compile.debug)
  ...
  [2010-1-26T23:35:45] LoggerDrive#initialize() [hoge<String>:root1<LoggerDrive>,fuga<String>:1<int>]<Object>
  [2010-1-26T23:35:45] LoggerDrive#initialize() MovieClip<String>,instance1<flash.display::MovieClip>
